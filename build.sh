...
xcodebuild -project ./BlackHole.xcodeproj -scheme BlackHole -configuration Release -derivedDataPath $DERIVEDDATAPATH GCC_PREPROCESSOR_DEFINITIONS='$GCC_PREPROCESSOR_DEFINITIONS kDriver_Name=\"'${ASSEMBLY_NAME}_SpeakerCapture'\" kHas_Driver_Name_Format=false kManufacturer_Name=\"'${APP_DEVELOPER}'\"' -destination 'platform=macOS,arch=x86_64'
